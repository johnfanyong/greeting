...
/*
require("superagent-proxy")(superagent); //代理

var sslRootCAs = require("ssl-root-cas/latest"); //解决证书错误
sslRootCAs
  .inject()
  ...
  superagent
    ...
    .end((err1, res1) => {
      ...
      if (err1) {
        ...
        let cookie = res1.header["set-cookie"];
        if (cookie) {
          //checkCode = codeCookie[4];
          console.log("codeCookie", cookie);
        }
      }
    });
}
  ...
  if (name == "" || pass == "" || code == "") {
    ...
    superagent
      ...
      /*
        ...
        */
      .set(browserMsg)
      .set("authority", "www.sd7799.com")
      .set("method", "POST")
      .set("path", "/api/login.do")
      .set("scheme", "https")
      .set("Referer", urls.referer)
      .set("Content-Type", "application/x-www-form-urlencoded; charset=UTF-8")
      .set("Access-Control-Allow-Credentials", true)
      .set("Cookie", checkCode)
      // 避免登录后的302重定向
      //.redirects(0)
      //.use(superdebug)
      .use(logger)
      ...
      */
      .end((err, res) => {
        if (err) {
          ...
          console.error("登录失败.res", res);
          console.log("Oh no! error ", res._data);
        } else {
          console.log("登录成功");
          // 登录成功 获取tokenCookie
          // 获取tokenCookie
            ...
            fs.writeFile(
              ...
              function (err2) {
                ...
                document
                  ...
                  .setAttribute("src", "code.png?v=" + Math.random());
              }
            );
          });
      }
